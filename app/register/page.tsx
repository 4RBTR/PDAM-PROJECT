            ...
            <div className="w-full lg:w-1/2 flex flex-col p-6 sm:p-12 relative overflow-y-auto">
                ...
                <div className="w-full max-w-md mx-auto my-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Email */}
                        <div>
                            <label className="text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 block ml-1">Alamat Email</label>
                        ...
                        {/* Password */}
                        <div>
                            <label className="text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 block ml-1">Kata Sandi</label>
                        ...
                        {/* Address */}
                        <div>
                            <label className="text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 block ml-1">Alamat Tinggal / Pemasangan</label>
                            <textarea required name="address" placeholder="Sebutkan jalan, RT/RW, kelurahan..." onChange={handleChange}
                                className="w-full px-5 py-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900 focus:bg-white dark:focus:bg-slate-950 focus:border-blue-500 dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-sm font-medium placeholder:text-slate-400 dark:placeholder:text-slate-500 text-slate-900 dark:text-slate-100 h-24 resize-none" />
                        </div>
