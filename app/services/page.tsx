                        ...
                        <div className="hidden md:flex items-center gap-2">
                            {['About', 'Services', 'Contact'].map((item) => (
                                <Link
                                    ...
                                    className={`px-4 py-2 text-[13px] font-bold rounded-full transition-all duration-300 relative group/item ${item === 'Services' ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-300'}`}
                                >
            ...
            <main className="grow pt-32 pb-24 md:pt-44 container mx-auto px-6 relative z-10 max-w-6xl">
                ...
                <div className="text-center mb-16 md:mb-24">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800/50 rounded-full mb-6">
                        ...
                        <span className="text-[11px] font-bold tracking-widest text-indigo-600 dark:text-indigo-400 uppercase">Our Solutions</span>
                    </div>
                    <h1 className="text-4xl md:text-6xl font-black mb-6 text-slate-900 dark:text-white tracking-tighter leading-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-slate-900 via-indigo-600 to-slate-900 dark:from-white dark:via-indigo-400 dark:to-white">Kebutuhan Air Anda.</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-24">
                    {services.map((item, idx) => (
                        <div key={idx} className="bg-white dark:bg-slate-900 p-8 rounded-4xl border border-slate-100 dark:border-slate-800 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.04)] dark:shadow-none hover:shadow-[0_20px_40px_-10px_rgba(79,70,229,0.1)] dark:hover:shadow-[0_20px_40px_-10px_rgba(79,70,229,0.2)] hover:border-indigo-100 dark:hover:border-indigo-800 hover:-translate-y-1 transition-all duration-300 group">
                ...
                {/* CTA / Help Section */}
                <div className="relative rounded-4xl overflow-hidden bg-slate-900 text-white p-8 md:p-14 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-slate-200 dark:shadow-none border border-transparent dark:border-slate-800">
                    {/* Decoration */}
