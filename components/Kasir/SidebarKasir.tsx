        ...
        <>
            ...
            >
                ...
                <div className="p-6 lg:p-8 border-b border-slate-100/60 dark:border-slate-800 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="text-[10px] text-blue-600 dark:text-blue-400 font-black tracking-widest uppercase mt-0.5 block">Kasir Panel</span>
                        </div>
                    </div>
                ...
                <div className="p-5 border-t border-slate-100/60 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900 rounded-b-4xl lg:rounded-none space-y-4">
                    ...
                    >
                        <div className="w-10 h-10 bg-linear-to-tr from-emerald-600 to-emerald-400 rounded-xl flex items-center justify-center text-white font-black overflow-hidden ring-2 ring-white dark:ring-slate-800 shadow-sm transition-transform group-hover:scale-105 relative">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-black text-slate-800 dark:text-slate-100 truncate group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors uppercase leading-tight">{user?.name || "Memuat..."}</p>
