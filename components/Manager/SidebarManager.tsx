...
interface SidebarProps {
    ...
    activePage?: string;      // Halaman aktif (opsional)
}
        ...
        <>
            ...
            >
                ...
                <div className="p-5 border-t border-slate-100/60 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900 rounded-b-4xl lg:rounded-none space-y-4">
                    ...
                    >
                        <div className="w-10 h-10 bg-linear-to-tr from-indigo-600 to-indigo-400 rounded-xl flex items-center justify-center text-white font-black overflow-hidden ring-2 ring-white dark:ring-slate-800 shadow-sm transition-transform group-hover:scale-105 relative">
